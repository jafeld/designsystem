        ...
        return (
            <div className="ffe-file-upload">
                <div className="ffe-file-upload__info-section">
                    <div className="ffe-file-upload__info-section-title">
                        {infoTitle}
                    </div>
                    {Object.keys(files).length > 0 ? (
                        <div className="ffe-file-upload__info-section-files">
                ...
                >
                    <div
                        className={`ffe-file-upload__upload-section-border${
                            this.state.hover
                                ? ' ffe-file-upload__upload-section-border__hover'
                                : ''
                        }`}
                    >
